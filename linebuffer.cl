...
// Address spaces for kernel_A_loader
 ...
 __address_space__A const float *_A)
{
 ...
 for (int _A_loader_s0_y_y = 0; _A_loader_s0_y_y < 0 + _1; _A_loader_s0_y_y++)
 {
  ...
  {
   int _6 = _C_extent_0 + 63;
   int _7 = _6 >> 6;
   _2 = _7;
  } // if _5 else
  for (int _A_loader_s0_x_x = 0; _A_loader_s0_x_x < 0 + _2; _A_loader_s0_x_x++)
  {
   for (int _A_loader_s0_y_yy = 0; _A_loader_s0_y_yy < 0 + 66; _A_loader_s0_y_yy++)
   {
    for (int _A_loader_s0_x_xx = 0; _A_loader_s0_x_xx < 0 + 66; _A_loader_s0_x_xx++)
    {
     int _8 = _A_loader_s0_x_x * 64;
     int _9 = _8 + _C_min_0;
     int _10 = _C_min_0 + _C_extent_0;
     int _11 = _10 + -64;
     int _12 = min(_9, _11);
     int _13 = _12 + _A_loader_s0_x_xx;
     int _14 = _A_loader_s0_y_y * 64;
...
__kernel void kernel_A_feeder(
)
{
 while (1)
 {
  define_flat_linebuffer(float, _A_loader_0_channel, _A_feeder_0_channel, 64, 64, 1, 1, 3, 3, 1, 1, 1, 1, 1, 1);
 ...
 __address_space__B const float *_B)
{
 ...
 for (int _B_loader_s0_y_y = 0; _B_loader_s0_y_y < 0 + _27; _B_loader_s0_y_y++)
 {
  ...
  {
   int _32 = _C_extent_0 + 63;
   int _33 = _32 >> 6;
   _28 = _33;
  } // if _31 else
  for (int _B_loader_s0_x_x = 0; _B_loader_s0_x_x < 0 + _28; _B_loader_s0_x_x++)
  {
   for (int _B_loader_s0_y_yy___yy___xx___win2__y___win2__x__flattened_loop__no_loop_counter = 0; _B_loader_s0_y_yy___yy___xx___win2__y___win2__x__flattened_loop__no_loop_counter < 0 + 65536; )
   {
    // block start
...
)
{
 ...
 while (1)
 {
  for (int _B_feeder_s0_y_yy___yy___xx___win2__y___win2__x__flattened_loop__no_loop_counter = 0; _B_feeder_s0_y_yy___yy___xx___win2__y___win2__x__flattened_loop__no_loop_counter < 0 + 65536; )
  {
   // block start
   float _51;
 ...
 __address_space__C float *_C)
{
 ...
 for (int _C_s1_y_y = 0; _C_s1_y_y < 0 + _68; _C_s1_y_y++)
 {
  ...
  {
   int _74 = _C_extent_0 + 63;
   int _75 = _74 >> 6;
   _69 = _75;
  } // if _73 else
  for (int _C_s1_x_x = 0; _C_s1_x_x < 0 + _69; _C_s1_x_x++)
  {
   for (int _C_s1_y_yy___yy___xx___win2__y__flattened_loop__no_loop_counter = 0; _C_s1_y_yy___yy___xx___win2__y__flattened_loop__no_loop_counter < 0 + 16384; )
   {
    // block start
    int _76 = _C_s1_x_x * 64;
    int _77 = _76 + _C_min_0;
    int _78 = _C_s1_y_yy___yy___xx___win2__y__flattened_loop__no_loop_counter & 255;
    int _79 = _78 >> 2;
    int _80 = _77 + _79;
    int _81 = _C_s1_y_y * 64;
    int _82 = _81 + _C_min_1;
    int _83 = _C_s1_y_yy___yy___xx___win2__y__flattened_loop__no_loop_counter >> 8;
    int _84 = _82 + _83;
    ...
    _C[_89] = _94;
    // block start
    int _95 = _C_s1_x_x * 64;
    int _96 = _95 + _C_min_0;
    int _97 = _C_s1_y_yy___yy___xx___win2__y__flattened_loop__no_loop_counter & 255;
    int _98 = _97 >> 2;
    int _99 = _96 + _98;
    int _100 = _C_s1_y_y * 64;
    int _101 = _100 + _C_min_1;
    int _102 = _C_s1_y_yy___yy___xx___win2__y__flattened_loop__no_loop_counter >> 8;
    int _103 = _101 + _102;
    ...
    _C[_108] = _113;
    // block start
    int _114 = _C_s1_x_x * 64;
    int _115 = _114 + _C_min_0;
    int _116 = _C_s1_y_yy___yy___xx___win2__y__flattened_loop__no_loop_counter & 255;
    int _117 = _116 >> 2;
    int _118 = _115 + _117;
    int _119 = _C_s1_y_y * 64;
    int _120 = _119 + _C_min_1;
    int _121 = _C_s1_y_yy___yy___xx___win2__y__flattened_loop__no_loop_counter >> 8;
    int _122 = _120 + _121;
 ...
 // block end
} // kernel kernel_C__run_on_device
